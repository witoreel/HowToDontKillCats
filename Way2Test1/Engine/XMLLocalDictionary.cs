...
namespace Way2Software1.Engine {
    ...
    /// </summary>
    [Serializable()]
    public class XMLLocalDictionary : LocalDictionary {

        #region ====== Enumeradores e Estruturas ======
        ...
        private void Load() {
            ...
            if (File.Exists(FileName)) {
                ...
                try {
                    ...
                    XMLLocalDictionary accessList = (XMLLocalDictionary)deserializer.Deserialize(stream);
                    stream.Close();
